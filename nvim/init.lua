...
vim.keymap.set('n', '<leader>t', require('nvim-tree.api').tree.toggle, { desc = 'nvim-[T]ree [F]iles' })

require('which-key').register({
  ['<leader>s'] = { name = '[S]earch', _ = 'which_key_ignore' },
  ['<leader>f'] = { name = '[F]ile', _ = 'which_key_ignore' },
  ['<leader>t'] = { name = 'nvim-[t]tree', _ = 'which_key_ignore' },
...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ensure_installed = { 'lua', 'python', 'markdown', 'markdown_inline', 'html', 'scss'},
    modules = {},
